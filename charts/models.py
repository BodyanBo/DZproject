...
class Assets(models.Model):
    ...
    indicator = models.ForeignKey('Indicators', on_delete = models.SET_NULL, blank=True, null=True)
...
class Indicators(models.Model):
    ...
    indicator_name = models.ForeignKey('Indicatornames',on_delete = models.DO_NOTHING)
...
class Office(models.Model):
    ...
    city = models.ForeignKey('CityRegion',on_delete = models.DO_NOTHING)
